...
import { fetchGLSParcelShopData } from '../services/glsParcelShopService';
import type { GLSParcelShopItem } from '../services/glsParcelShopService';
    ...
    <div className="space-y-6">
            ...
            <div className="card-body">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-lg font-bold text-accent">PARCEL SHOP</p>
                </div>
                <div className="text-3xl">🏪</div>
              </div>
            </div>
      ...
      {data && data.shipments.length > 0 && (
        <div className="card bg-base-100 shadow-sm">
          <div className="card-body">
            <h2 className="card-title font-bold">Spedizioni Parcel Shop</h2>
            <div className="overflow-x-auto">
              <table className="table table-zebra">
                ...
                <tbody>
                  {data.shipments.map((shipment: GLSParcelShopItem, index: number) => (
        ...
        <div className="card bg-base-100 shadow-sm">
          <div className="card-body text-center py-12">
            ...
            <p className="text-base-content/70">
              Non ci sono spedizioni consegnate in Parcel Shop nel periodo selezionato.
            </p>
          </div>
        </div>
      )}
